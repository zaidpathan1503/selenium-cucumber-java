...
public class TestDataJSONReader{
    ...
    public static  List<HashMap<String,String>> readJsonArray(String requestKey) throws Exception{
    ...
    public static HashMap<String,String> readJsonObject(String requestKey) throws Exception {
